...
bot.start((ctx) => ctx.reply('Здравствуйте для получения большей информации воспользуйтесь командой /help'))
...
bot.on('message',(ctx) => ctx.reply('Команда не найдена\n\nвоспользуйтесь командой /help чтобы узнать у существующих командах'))
bot.launch()